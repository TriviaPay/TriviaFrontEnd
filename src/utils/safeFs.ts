...
/**
 * Delete a file path safely. Never throws and never passes null/undefined to RNFS.
 */
export const safeUnlink = async (path?: string | null): Promise<void> => {
